...
children; the bulk create checks every key once — insertTopic's own check — skips a
taken one and settles the skipped row; both candidate create paths look the planned
nodes up first and take a topic they could not map back out).

...
export function renderEmail(
  ...
  if (segment === "no_book") {
    return {
      ...
      text: [
        ...
        "plus five documents you can take straight into class — lesson plan,",
        "worksheet, activity, exam paper and case study.",
        "",
  ...
  return {
    ...
    text: [
      ...
      "five documents for that chapter — lesson plan, worksheet, activity, exam",
      "paper and case study. It runs in the background, so you can close the tab",
      "and come back to it.",
      "",
      "Open your library:",
      f.appUrl,

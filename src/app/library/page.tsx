...
// the doors into the taxonomy screens. Every screen is readable by every
// member (the header shows every tab); the doors say where a role can only
// read, matching the read-only note the screen itself shows. Later phases
// replace the cards with the live queues (articles awaiting review, kits
// awaiting review, translations, publish failures) and the quota-window
// indicator.
